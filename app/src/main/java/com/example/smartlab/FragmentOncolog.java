...
public class FragmentOncolog extends Fragment {
    View v;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        v = inflater.inflate(R.layout.fragment_oncolog, container, false);

        analyses = new ArrayList<Analysis>();
        RecyclerView listView = v.findViewById(R.id.recyclerViewOncolog);
            ...
            public void onResponse(Call<AnalysisResult> call, Response<AnalysisResult> response) {
                if (response.isSuccessful()){
                    ...
                    for (Analysis analysis: analisResponseList){
                        if (analysis.getCategoryString().contains("4")){
